...
<?php 
  ...
  echo "<center><h3>训练赛编辑</h3></center>";
...
if(isset($_POST['startdate'])){
  ...
  $sql = "UPDATE `contest` SET `title`=?,`description`=?,`start_time`=?,`end_time`=?,`private`=?,`langmask`=?,`password`=?,`login_ip_limit`=? WHERE `contest_id`=?";
  //echo $sql;
  pdo_query($sql,$title,$description,$starttime,$endtime,$private,$langmask,$password,$login_ip_limit,$cid);
