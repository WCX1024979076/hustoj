...
if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    else if($type==1)
    {
        ...
        $sql="INSERT INTO `level_list`(`level_id`,`level_name`,`level_problem_min`,`easy_cid`,`hard_cid`) VALUES(?,?,?,?,?)";
        pdo_query($sql,$data_array[0],$data_array[1],$data_array[2],$data_array[3],$data_array[4]);
        echo "添加成功";
    }
    else if($type==2)
    {
        ...
        $sql="INSERT INTO `level_list`(`level_id`,`level_name`,`level_problem_min`,`easy_cid`,`hard_cid`) VALUES(?,?,?,?,?)";
        pdo_query($sql,$data_new_array[0],$data_new_array[1],$data_new_array[2],$data_new_array[3],$data_new_array[4]);
        echo "添加成功";
