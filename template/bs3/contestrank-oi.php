  ...
  <div class="container">
    ...
    <div class="jumbotron">
      ...
      <nav id="page" class="center">
        <ul class="pagination">
          <li class="page-item"><a href="contestrank-oi.php?cid=<?php echo $cid ?>&page=1">&lt;&lt;</a></li>
          <?php
        ...
        <a href='contestrank-oi.php?cid=" . $cid . "&page=" . $i . "'>" . $i . "</a></li>";
          }
          ?>
          <li class="page-item"><a href="contestrank-oi.php?cid=<?php echo $cid ?>&page=<?php echo $view_total_page ?>">&gt;&gt;</a>
          </li>
        </ul>
      </nav>
...
<nav id="page" class="center">
        ...
        <a href='contestrank-oi.php?cid=" . $cid . "&page=" . $i . "'>" . $i . "</a></li>";
                ...
                <li class="page-item"><a
                            href="contestrank-oi.php?cid=<?php echo $cid ?>&page=<?php echo $view_total_page ?>">&gt;&gt;</a>
                </li>
            </ul>
        </nav>
