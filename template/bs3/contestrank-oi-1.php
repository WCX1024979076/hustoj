...
<body>
    <div class="container">
        ...
        <div class="jumbotron">
            ...
            <center>
                <nav id="page" class="center">
                    <ul class="pagination">
                        <li class="page-item"><a href="contestrank-oi-1.php?cid=<?php echo $cid ?>&page=1">&lt;&lt;</a></li>
                        <?php
        ...
        <a href='contestrank-oi-1.php?cid=" . $cid . "&page=" . $i . "'>" . $i . "</a></li>";
                        }
                        ?>
                        <li class="page-item"><a href="contestrank-oi-1.php?cid=<?php echo $cid ?>&page=<?php echo $view_total_page ?>">&gt;&gt;</a>
                        </li>
                    </ul>
                </nav>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            setTimeout(function() {
                document.location.href = '/contestrank-oi-1.php?cid=<?php echo $cid ?>'
            }, 60000);
        });
    </script>
